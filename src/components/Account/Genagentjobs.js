...
class Genagentjobs extends Component {
constructor(props) {
    super(props);
    this.state = {
      activegc:'enable',
                    ...
                    <div className="sdmenu_wrapper">
                        ...
                        <div className="sdmenu_tabcontent">
                            <div className="sdhmenu_wrapper">
                                ...
                                <Link to={"/genagent-jobs"} className="sdhmenu_mtabtrigger active" title="GenRun Details">Jobs <i className="fa fa-angle-down"></i></Link>
